...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    FallbackImage: typeof import('./../components/fallback-image.vue')['default']
    ...
    IconParkOutlineErrorPicture: typeof import('~icons/icon-park-outline/error-picture')['default']
